...
TYPED_TEST(ComponentInterfaceParameterTest, AddParameter) {
  EXPECT_THROW(auto discard = this->component_->get_parameter("test"), modulo_core::exceptions::ParameterException);
...
TYPED_TEST(ComponentInterfaceParameterTest, SetParameter) {
  ...
  EXPECT_THROW(
      this->component_->template get_parameter_value<int>("test"), modulo_core::exceptions::ParameterException);
