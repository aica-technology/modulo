...
void ControllerInterface::add_variant_predicate(const std::string& name, const PredicateVariant& predicate) {
  if (name.empty()) {
...
void ControllerInterface::set_variant_predicate(const std::string& name, const PredicateVariant& predicate) {
